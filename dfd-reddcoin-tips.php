...
// Widgets
require_once( 'includes/widgets/widget_1.php' );
add_action( 'widgets_init', 'dfd_rdd_register_widget_1' );
require_once( 'includes/widgets/widget_2.php' );
add_action( 'widgets_init', 'dfd_rdd_register_widget_2' );
